...
|---|---|---|
| **[fathom](https://github.com/NeilP211/fathom)** ![NEW](https://img.shields.io/badge/NEW-6fffe0?style=flat-square) | A **survival-horror game in an infinite procedural ocean**, in the browser on **WebGPU** (auto WebGL2 fallback). Seeded marching-cubes terrain streamed from a Web Worker pool, **5,000 GPU-compute boid fish** that react to your light and noise, a buildable submersible, a leviathan that hunts by sound, and a 5-site mystery descending to an 800m abyss. **[Play it live](https://neilp211.github.io/fathom/)**. | `three.js` `WebGPU` `TSL compute` `Web Audio` `Vite` |
